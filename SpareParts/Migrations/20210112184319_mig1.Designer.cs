...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpareParts.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("SpareParts.Models.ProductWishList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SpareParts.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SpareParts.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SpareParts.Models.Category", b =>
                {
                    b.HasOne("SpareParts.Models.Category", "ParentCategory")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("SpareParts.Models.Product", b =>
                {
                    ...
                    b.HasOne("SpareParts.Models.Supplier", "Supplier")
                        .WithMany("Products")
